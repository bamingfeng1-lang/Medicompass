...
export function Navbar({
  ...
  const links = [
    ...
    { href: p("/car-t"), label: dict.nav.carT },
    { href: p("/second-opinion"), label: dict.nav.secondOpinion },
    { href: p("/private-doctor"), label: dict.nav.privateDoctor },
    { href: p("/basic-medical"), label: dict.nav.basicMedical },
    { href: p("/cross-border-medical"), label: dict.nav.crossBorderMedical },
    { href: p("/longevity-medical"), label: dict.nav.longevityMedical },
    ...
    <header className="sticky top-0 z-50 border-b border-white/60 bg-white/80 backdrop-blur-xl">
      <nav className="container-page flex h-16 items-center justify-between lg:h-20">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <Link
            href={switchHref}
            className="flex items-center gap-1.5 rounded-full border border-slate-200 px-3.5 py-2 text-sm font-medium text-slate-600 transition hover:border-brand-deep hover:text-brand-deep whitespace-nowrap"
          >
          ...
          {user ? (
            ...
            <>
              <Link
                href={p("/login")}
                className="rounded-full px-4 py-2 text-sm font-medium text-slate-600 transition hover:text-brand-deep whitespace-nowrap"
              >
                {dict.nav.login}
              </Link>
              <Link href={p("/second-opinion/apply")} className="btn-primary text-xs">
                {dict.nav.cta}
              </Link>
            </>
          )}
