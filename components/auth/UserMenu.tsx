...
import { UserCircle, LogOut, ChevronDown, ClipboardList, IdCard, KeyRound } from "lucide-react";
...
export function UserMenu({
  ...
  const onLogout = async () => {
    await fetch(clientApi("/api/auth/logout"), { method: "POST", credentials: "include" });
    setOpen(false);
    router.replace(`/${lang}`);
    router.refresh();
  };
